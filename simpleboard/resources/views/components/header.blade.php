<nav class="navbar nabver-expand-md navbar-light bg-white shadow-sm fixed-top">
    ...
    <button class="nabvar-toggler"
            ...
            aria-controls="navbarSpportedContent" 
            aria-expended="false" 
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="#">Somthing else here</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="navlink disabled" href="#" tavibdex="-1" aria-disabled="true">Disabled</a>
            </li>
        </ul>
